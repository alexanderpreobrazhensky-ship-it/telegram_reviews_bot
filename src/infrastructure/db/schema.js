const schemaOverview = {
  ...
  requests: ['id', 'client_id', 'vehicle_id', 'request_type', 'status', 'description', 'source_channel', 'assigned_master_id', 'lost_reason', 'created_at', 'updated_at', 'data'],
  request_events: ['id', 'event_scope', 'event_type', 'request_id', 'client_id', 'quality_case_id', 'actor_id', 'actor_role', 'created_at', 'data', 'parent_event_id'],
  ...
  analytics_events: ['id', 'parent_event_id', 'event_type', 'source_system', 'processing_status', 'related_entity_type', 'related_entity_id', 'dedupe_key', 'created_at', 'processed_at', 'data'],
