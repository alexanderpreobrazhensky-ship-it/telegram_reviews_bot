const schemaOverview = {
  clients: ['id', 'full_name', 'phone', 'email', 'telegram_id', 'max_id', 'preferred_channel', 'external_ids', 'source_system', 'source_of_truth', 'last_synced_at', 'local_pending_changes', 'needs_manual_review'],
  staff_users: ['id', 'telegram_id', 'max_id', 'full_name', 'role'],
  ...
  communication_events: ['id', 'client_id', 'request_id', 'source', 'channel', 'direction', 'payload'],
